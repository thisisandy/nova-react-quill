...
declare module 'quill2' {
  ...
  export type TextChangeHandler = (delta: QuillDelta,
  ...
  export interface QuillEditor extends EventEmitter {
    ...
    insertEmbed(index: number, type: string, value: any,
       source?: Sources): QuillDelta;

    insertText(index: number, text: string, source?: Sources): QuillDelta;

    insertText(index: number, text: string, format: string,
      value: any, source?: Sources): QuillDelta;
    ...
    formatLine(index: number,
      length: number, source?: Sources): QuillDelta;
